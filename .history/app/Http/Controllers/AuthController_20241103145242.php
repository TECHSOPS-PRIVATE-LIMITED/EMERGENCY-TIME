    ...
    public function sendOtp(Request $request)
{
    ...
    // Save the OTP to the user (optional, if you want to store it)
    $user->otp = $otp; // Ensure you have an 'otp' column in your users table
    $user->save();

    // Send the OTP email
    Mail::to($user->email)->send(new OtpMail($otp)); // Use $user->email here
