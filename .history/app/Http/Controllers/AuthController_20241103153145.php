    ...
    public function sendOtp(Request $request)
{
    ...
    session(['otp' => $otp, 'otp_email' => $user->email]); // Store email too
...
public function verifyOtp(Request $request)
{
    ...
    // Check if the email matches with the session
    ...
    $user = User::where('email', session('otp_email'))->first(); // Fetch user by email stored in session
