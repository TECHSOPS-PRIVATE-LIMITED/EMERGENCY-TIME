    ...
    public function store(Request $request)
{
    ...
    public function getProviders(Request $request)
    {
        ...
        $providers = Provider::where('nationality', $countryId)->get();
        $responseData = $providers->map(function ($provider) {
            return [
                'id' => $provider->id,
                'full_name' => $provider->full_name,
                'profile_picture' => Storage::url($provider->profile_picture),
                'speciality_id' =>$provider->speciality->speciality_name
