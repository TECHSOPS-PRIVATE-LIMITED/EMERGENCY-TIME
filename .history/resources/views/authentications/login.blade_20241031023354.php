                            ...
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin">
                                    <div class="mb-5 d-flex">
                                        <a href="{{ route('login.show')}}"><img src="{{asset('admin/assets/images/brand-logos/desktop-white.jpg')}}"
                                            class="desktop-logo ht-70" alt="logo">
                                            <img src="{{asset('admin/assets/images/brand-logos/desktop-white.jpg')}}"
