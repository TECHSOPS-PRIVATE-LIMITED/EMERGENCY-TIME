        ...
        <div class="row m-0">
            <div class="col-12 p-0">    
                <div class="login-card login-dark">
                    <div>
                        <div><a class="logo" href="index.html"><img class="img-fluid for-light m-auto" src="{{ asset('admin/assets/images/logo/logo1.png') }}" alt="loginpage"><img class="img-fluid for-dark" src="{{ asset('admin/assets/images/logo/logo-dark.png') }}" alt="logo"></a></div>
