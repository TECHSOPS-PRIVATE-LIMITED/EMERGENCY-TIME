...
<body>
    ...
    <div class="container-fluid p-0">
        <div class="row m-0">
            ...
            <div class="login-card login-dark" style="background-image: url('{{ asset('admin/assets/images/backgrounds/your-new-background.jpg') }}'); background-size: cover; background-repeat: no-repeat; background-position: center; height: 100vh;">

                    <div>
                        <div><a class="logo" href="index.html"><img class="img-fluid for-light m-auto" src="{{ asset('admin/assets/images/logo/logo.png') }}" alt="loginpage"><img class="img-fluid for-dark" src="{{ asset('admin/assets/images/logo/logo.png') }}" alt="logo"></a></div>
