            ...
            <div class="user-profile">
              <div class="row">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="cardheader" style="background-image: url('{{ asset('admin/assets/images/other-images/bg-profile1.jpg') }}'); background-size: cover; background-position: center;">
                  </div>
