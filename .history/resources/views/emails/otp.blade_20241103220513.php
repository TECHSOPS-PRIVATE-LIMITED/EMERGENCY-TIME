              ...
              <tbody>
                <tr>
                  <td style="padding: 30px"> 
                    ...
                    <p style="text-align: center" style="padding: 10px; background-color:#308e87; color: #fff; display: inline-block; border-radius:30px; font-weight:700; padding:0.6rem 1.75rem;">{{ $otp }}</style></p>
