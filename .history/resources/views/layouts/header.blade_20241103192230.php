            ...
            <ul class="header-right"> 
              ...
              <li class="custom-dropdown"><a href="javascript:void(0)">
                ...
                <div class="custom-menu cart-dropdown py-0 overflow-hidden">
                  ...
                  <ul class="pb-0">
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('admin/assets/images/dashboard-2/1.png')}}" alt=""/>
                    ...
                    <li>
                      <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('admin/assets/images/dashboard-2/2.png')}}" alt=""/>
