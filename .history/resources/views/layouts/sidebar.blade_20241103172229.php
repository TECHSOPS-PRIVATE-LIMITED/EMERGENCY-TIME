          ...
          <div class="main-sidebar" id="main-sidebar">
            <ul class="sidebar-menu" id="simple-bar">
              ...
              <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link" href="file-manager.html">
                  ...
                  <h6 class="f-w-600">Subscription Plans </h6></a>
              </li>
              ...
              <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link" href="javascript:void(0)">
                  ...
                  <h6 class="f-w-600">Dcotors</h6><i class="iconly-Arrow-Right-2 icli"></i></a>
                <ul class="sidebar-submenu">
                  <li> <a href="project-list.html">Doctors List </a></li>
                  <li> <a href="projectcreate.html">Add Doctor </a></li>
                </ul>
              </li>
