            ...
            <li class="sidebar-main-title">
              ...
              <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link" href="javascript:void(0)">
                ...
                <ul class="sidebar-submenu">
                  <li> <a href="project-list.html">All Plans</a></li>
                  <li> <a href="projectcreate.html">Create Plan</a></li>
                </ul>
              </li>
              ...
              <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link" href="javascript:void(0)">
                ...
                <ul class="sidebar-submenu">
                  <li> <a href="project-list.html">Specialities List</a></li>
              ...
              <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link" href="javascript:void(0)">
                ...
                <ul class="sidebar-submenu">
                  <li> <a href="project-list.html">Providers List</a></li>
              ...
              <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link" href="javascript:void(0)">
                ...
                <ul class="sidebar-submenu">
                  <li> <a href="project-list.html">Patients List</a></li>
              ...
              <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link" href="javascript:void(0)">
                  ...
                  <h6 class="f-w-600">Appointment</h6><i class="iconly-Arrow-Right-2 icli"></i></a>
                <ul class="sidebar-submenu">
                  <li> <a href="project-list.html">Patients List</a></li>
                  <li> <a href="projectcreate.html">Eroll Patients</a></li>
                </ul>
              ...
              <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link" href="file-manager.html">
                  ...
                  <h6 class="f-w-600">Transaction List</h6></a>
              </li>
