        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="speciality_image" class="form-label">Speciality Image</label>
                        <input type="file" class="form-control" id="speciality_image" name="speciality_image">
                    </div>
                    <div class="mb-3">
                        <label for="country_id" class="form-label">Country</label>
                        <select class="form-control" id="country_id" name="country_id" required>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        editModal.addEventListener('show.bs.modal', function (event) {
            ...
            var specialityCountry = button.getAttribute('data-country-id');
            ...
            document.getElementById('country_id').value = specialityCountry;

            // Clear the file input (as it cannot be pre-filled for security reasons)
            document.getElementById('speciality_image').value = '';
        });
    });
</script>
@endsection
