...
<header class="page-header row">
        <div class="logo-wrapper d-flex align-items-center col-auto"><a href="index.html"><img class="light-logo img-fluid" src="{{asset( 'admin/assets/images/logo/logo1.png') }}" alt="logo"/><img class="dark-logo img-fluid" src="../assets/images/logo/logo-dark.png" alt="logo"/></a><a class="close-btn toggle-sidebar" href="javascript:void(0)">
            <svg class="svg-color">
                ...
                <div class="custom-menu overflow-hidden">
                  <ul class="profile-body">
                    <li class="d-flex">
                      ...
                      </svg><a class="ms-2" href="{{ route('client.profile') }}">Account</a>
                    </li>
                    <li class="d-flex">
                      <svg class="svg-color">
