...
<aside class="page-sidebar">
    ...
    <div class="main-sidebar" id="main-sidebar">
        <ul class="sidebar-menu" id="simple-bar">
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link" href="{{ route('client.index')}}">
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                    ...
                    <h6 class="f-w-600">NearBy Hospitals </h6>
                </a>
            </li>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                    ...
                    <h6 class="f-w-600">Medical Chatbot </h6>
                </a>
            </li>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                    ...
                    <h6 class="f-w-600">Providers</h6><i class="iconly-Arrow-Right-2 icli"></i>
                </a>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                    ...
                    <h6 class="f-w-600">BMI Calculator </h6>
                </a>
            </li>
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
                    ...
                    <h6 class="f-w-600">ER Physician </h6>
                </a>
            </li>
