            ...
            <div class="main-sidebar" id="sidebar-scroll">
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide__category"><span class="category-name">Health</span></li>
                        <!-- Start::slide -->
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">
                                ...
                                <span class="side-menu__label">Health Plans</span>
                                <i class="fe fe-chevron-right side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide has-sub">
                                    <a href="javascript:void(0);" class="side-menu__item">Add Plans
                                    </a>
                                </li>
                                 <li class="slide has-sub">
                                    <a href="javascript:void(0);" class="side-menu__item">Plans List
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                <li class="slide has-sub">
                                    <a href="javascript:void(0);" class="side-menu__item">Subscribers List
                                    </a>
                                </li>
                                <li class="slide has-sub">
                                    <a href="javascript:void(0);" class="side-menu__item">Wallets
                                    </a>
                                </li>    
                            </ul>
                        </li>
                        <!-- End::slide -->
                         <li class="slide__category"><span class="category-name">Doctors</span></li>
                        <!-- Start::slide -->
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">
                                <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg>
                            ...
                            <ul class="slide-menu child1">
                                <li class="slide has-sub">
                                    <a href="javascript:void(0);" class="side-menu__item">Add Doctor
                                    </a>
                                </li>
                                <li class="slide has-sub">
                                    <a href="javascript:void(0);" class="side-menu__item">Doctors List
                                    </a>
                                </li>
                                <li class="slide has-sub">
                                    <a href="javascript:void(0);" class="side-menu__item">Appointments
                                    </a>
                                </li>       
                            </ul>
                        </li>
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                <li class="slide has-sub">
                                    <a href="javascript:void(0);" class="side-menu__item">General Settings
                                    </a>
                                </li>
                                <li class="slide has-sub">
                                    <a href="javascript:void(0);" class="side-menu__item">Roles Permissions
                                    </a>
                                </li>     
                            </ul>
                        </li>
